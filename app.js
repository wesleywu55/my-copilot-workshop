...
/** 從 localStorage 讀回篩選條件,讀不到或不合法時使用全部 */
function loadFilter() {
...
function toggleTodo(id) {
  ...
  const movedToActive = currentFilter === "completed" && todo?.completed;
  ...
  actionFeedback.textContent = movedToActive ? "已移至未完成清單。" : "";
  actionFeedback.hidden = !movedToActive;
}
